...
const RESERVED_SLUGS = ["mission", "team", "our-story"];
...
export const AboutPagesCollection: Collection = {
  name: "aboutPages",
  ...
  fields: [
    ...
    },
    {
      ...
      type: "number",
      description:
        "Lower numbers appear first in the dropdown (after the 3 fixed pages)",
    },
    {
      name: "heroImage",
